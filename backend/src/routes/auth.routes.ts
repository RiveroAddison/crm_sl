...
import { login, me, selectContext, switchEmpresa, logout, refresh } from '../controllers/auth.controller.js';
...
router.post('/switch-empresa', authRateLimiter, switchEmpresa);
